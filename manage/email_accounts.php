...
$tpl->assign("all_collections", Collection::getAll());

// @@@ CK - changed to check role by primary collection
//$role_id = User::getRoleByUser(Auth::getUserID());
$prj_id = Auth::getCurrentCollection();
$role_id = User::getRoleByUserCollection(Auth::getUserID(), $prj_id);
