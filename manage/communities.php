...
*/
	...
	$xdis_id = 11; // 11 is hardcoded at the moment as it is the fedora community xdis_id but this ID will move to a conf file or db entry later
	$xsd_display_fields = (XSD_HTML_Match::getListByDisplay($xdis_id));
	$tpl->assign("xsd_display_fields", $xsd_display_fields);
	$tpl->assign("xdis_id", $xdis_id);
	$tpl->assign("form_title", "Create New Community");
	$tpl->assign("form_submit_button", "Create Community");

    $tpl->assign("list", Community::getList());
