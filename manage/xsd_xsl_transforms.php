...
$tpl->assign("type", "xsd_xsl_transforms");
...
if ($role_id == User::getRoleID('administrator')) {
    ...
    if (@$HTTP_POST_VARS["cat"] == "new") {
        $tpl->assign("result", XSD_XSL_Transform::insert($xsd_id));
/*    } elseif (@$HTTP_POST_VARS["cat"] == "update") {
        $tpl->assign("result", XSD_XSL_Transform::update()); */
    } elseif (@$HTTP_POST_VARS["cat"] == "delete") {
        XSD_XSL_Transform::remove();
    }

    if (@$HTTP_GET_VARS["cat"] == "edit") {
        $tpl->assign("info", XSD_XSL_Transform::getDetails($xsd_id));
    }
	$tpl->assign("xsd_id", ($xsd_id));
//	print_r(XSD_XSL_Transform::getList($xsd_id));
    $tpl->assign("list", XSD_XSL_Transform::getList($xsd_id));
