...
//                echo "DB ERROR CK";
            ...
            echo "EXEC query -> ".print_r($this->query($query)); echo "end EXEC.";
            $res =& $this->query($query);
        }
...
//        echo "pre res = "; print_r($res);
        ...
        if ($fetchmode == 2) { echo "MONKEY DB OK!!!".print_r($row); }
...
//        echo "END RESULT!!!!".print_r($results);
        return $results;
    }
