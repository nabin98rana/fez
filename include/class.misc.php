...
//		}
	...
	public static function convertEstiRecordToMods($record, $author_id = false) 
	{
		...
		if($doc_type == 'MC' || $doc_type == 'M') {
		    ...
		    $mods['relatedItem']['originInfo']['place']['placeTerm'] =  $record->conferences->conference->conf_location->conf_city . ' ' . 
	...
	public static function convertEstiRecordToLinks($record) 
	{
		...
		if(@$record->item->article_nos->article_no) {
			...
			if(count($matches) == 4) {
				...
				$links[0]['id'] = 'link_1'; // 2010-04-07 MT: default to link_1 because this is currently only called by functions that deal with new records
