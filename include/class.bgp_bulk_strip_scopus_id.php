...
class BackgroundProcess_Bulk_Strip_Scopus_ID extends BackgroundProcess
{
	function __construct()
	{
		parent::__construct();
		$this->include = 'class.bgp_bulk_strip_scopus_id.php';
		$this->name = 'Bulk Strip scopus id from record';
	}
