...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US">
	<head>
		<title>NAJAX Advanced Chat</title>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<?= NAJAX_Utilities::header('../..') ?>

		<?= NAJAX_Utilities::eventsHeader() ?>

		<script type="text/javascript">

		najax.events.refreshInterval = 1000;

		var client = <?= NAJAX_Client::register(new ChatClient(), array('class' => 'ChatClient')) ?>;
	...
	<body>
		<table cellpadding="0" cellspacing="0" border="0" width="100%"
			summary="NAJAX Advanced Chat User Interface">
			<caption>Welcome to NAJAX Advanced Chat</caption>
			<tbody>
				<tr>
