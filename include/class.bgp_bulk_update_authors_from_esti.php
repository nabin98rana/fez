...
class BackgroundProcess_Bulk_Update_Authors_From_Esti extends BackgroundProcess
{
	function __construct()
	{
		parent::__construct();
		$this->include = 'class.bgp_bulk_update_authors_from_esti.php';
		$this->name = 'Bulk Update Authors From ESTI';
	}
