...
SQS_MESSAGE=$(<${BASE_DIR}/.docker/production/aws-task-definition.json)
...
SQS_MESSAGE_ATTRIBUTES='{"service": { "StringValue": "fezproduction", "DataType": "String" }, "commit_url": { "StringValue": "https://github.com/uqlibrary/fez/commit/<COMMIT_HASH>", "DataType": "String" }, "committer": { "StringValue": "<COMMITTER>", "DataType": "String" } }'
