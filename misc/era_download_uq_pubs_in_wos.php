	...
	if($records) {
		foreach($records->REC as $record) {
			...
			if(! $pid) {
    			...
    			//Record::insertFromArray($mods, 'UQ:86494', 'MODS 1.0', 'Imported from ESTI Search Service download', $times_cited);    
    			Record::insertFromArray($mods, 'UQ:180159', 'MODS 1.0', 'Imported from ESTI Search Service download', $times_cited);	
			}
		}
	}	
}
