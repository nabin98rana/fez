...
ALTER TABLE espace.%TABLE_PREFIX%record_search_key_isbn DROP INDEX rek_isbn_pid; 
...
ALTER TABLE espace.%TABLE_PREFIX%record_search_key_issn DROP INDEX rek_issn_pid; 
