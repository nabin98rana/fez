...
class BackgroundProcess_Links_Amr_Check extends BackgroundProcess
{
  function __construct()
  {
    parent::__construct();
    $this->include = 'class.bgp_links_amr_check.php';
  ...
  function checkLinksAmr() {
    ...
    // Clean out any remaining Researcher ID - UT to Author id (aut_id) relationships before proceeding
    // or it will treat these like RID downloads
    $queue = WokQueue::get();
