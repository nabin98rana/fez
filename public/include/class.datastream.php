...
class Datastream
{
    ...
    //Any changes here must be mirrored in swfuploader.js and changes to closed access (Currently only option 5) must be changed in security changes functions applied off these
