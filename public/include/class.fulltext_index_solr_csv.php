...
//			}
    ...
    while (($chunk = $queue->popChunk($singleColumns)) != false) {
      ...
      $csvHeader = 'id,' . implode(',', $singleColumnsHeader) . ',' . implode(',', $singleColumnsHeaderLookups) .
        ',sherpa_colour_t,ain_detail_t,rj_2014_rank_t,rj_2014_title_t,rj_2010_rank_t,rj_2010_title_t,rj_2012_rank_t,rj_2012_title_t,rc_2010_rank_t,rc_2010_title_t,herdc_code_description_t,' . $authLister_t . ',' . $authCreator_t . ',' . $authEditor_t . ',' .
