...
//			}
    ...
    while (($chunk = $queue->popChunk($singleColumns)) != false) {
      ...
      $csvHeader = 'id,' . implode(',', $singleColumnsHeader) . ',' . implode(',', $singleColumnsHeaderLookups) .
        ',open_access_t,sherpa_colour_t,ain_detail_t,rj_tier_rank_t,rj_tier_title_t,rj_2015_rank_t,rj_2015_title_t,rc_2015_rank_t,rc_2015_title_t,rj_2010_rank_t,rj_2010_title_t,rj_2012_rank_t,rj_2012_title_t,rc_2010_rank_t,rc_2010_title_t,herdc_code_description_t,' . $authLister_t . ',' . $authCreator_t . ',' . $authEditor_t . ',' .
