...
class XSD_HTML_Match
{
    ...
    private static function getXPATHTails($xpath, $xdis_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
    ...
    public static function getXSDMFIDByTitleXDIS_ID($title, $xdis_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
    ...
    public static function getXPATHBySearchKeyTitleXDIS_ID($sek_title, $xdis_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
    ...
    public static function getXSDMFIDBySearchKeyTitleXDIS_ID($sek_title, $xdis_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
    ...
    public static function getDetailsByXPATH($pid, $xdis_id, $exclude_list = array(), $specify_list = array(), $createdDT = null)
    {
        $log = FezLog::get();
...
//									$log->debug("XPATH fieldnode value: ".$fieldNode)
    ...
    public static function getDisplayType($pid)
    {
    ...
    public static function refreshXPATH($xsdmf_id = null, $traverse = true, $update_children = false)
    {
        $xpath = "";
    ...
    private static function isAttribute($xsdmf_element, $xdis_id)
    {
    ...
    private static function getXSDTypes($xsd_id)
    {
        static $xsd_array;
     ...
     * @return  boolean
     */
    private static function removeOptions($fld_id, $mfo_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     */
    private static function addOptions($fld_id, $options)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     * @return  boolean
     */
    private static function updateOption($mfo_id, $mfo_value)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     */
    public static function getAssocList($xdis_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     */
    private static function getBasicListByDisplay($xdis_id, $exclude_list = array(), $specify_list = array())
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     * @return  array The list of matching fields fields
     */
    public static function getNonSELChildListByDisplay($xdis_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     * @return  array The list of matching fields fields
     */
    public static function getSELChildListByDisplay($xdis_id, $xsdsel_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     * @return  array The list of matching fields fields
     */
    public static function getListByDisplay($xdis_id, $exclude_list = array(), $specify_list = array())
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     */
    private static function getOptionValue($fld_id, $value)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     */
    public static function getOptionValueByMFO_ID($mfo_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     * @return  boolean
     */
    public static function remove($xsdmf_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     * @return  boolean
     */
    public static function removeByXSDMF_IDs($xsdmf_ids = array())
    {
        $log = FezLog::get();
        $db = DB_API::get();
    ...
    public static function removeByXDIS_ID($xdis_id)
    {
     ...
     * @return  integer 1 if the insert worked, -1 otherwise
     */
    public static function insert($xdis_id, $xml_element)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     * @return  integer 1 if the insert worked, -1 otherwise
     */
    public static function insertFromArray($xdis_id, $insertArray)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     * @return  integer 1 if the insert worked, -1 otherwise
     */
    public static function insertFromArraySEL($xdis_id, $xsdsel_id, $insertArray)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     * @return  integer 1 if the insert worked, -1 otherwise
     */
    public static function update($xsdmf_id, $update_children = false)
    {
        $log = FezLog::get();
        $db = DB_API::get();
    ...
    private static function updateFromArray($xsdmf_id, $params)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     */
    public static function getXSDMF_IDByElement($xsdmf_element, $xsdmf_xdis_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
...
//				$log->debug("omg count not one! - ".print_r($res, true));
    ...
    private static function getXSDMF_IDsByElements($xsdmf_elements, $xsdmf_xdis_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     */
    public static function updateXSDMF_ID_REF($xsdmf_id, $new_xsdmf_id_ref, $new_id_ref_xdis_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
    ...
    private static function updateXPathByXSDMF_ID($xsdmf_id, $xpath)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     * @return  "" if failed, 1 if success.
     */
    public static function updateAuthorSuggestTarget($xsdmf_id, $new_xsdmf_id, $new_xdis_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     * @return  "" if failed, 1 if success.
     */
    public static function updateOrgFillTarget($xsdmf_id, $new_xsdmf_id, $new_xdis_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     * @return  "" if failed, 1 if success.
     */
    public static function updateParentOptionTarget($xsdmf_id, $new_xsdmf_id, $new_xdis_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     * @return  "" if failed, 1 if success.
     */
    public static function updateAttachedTarget($xsdmf_id, $new_xsdmf_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     * @return  array The XSDMF ID, or false if not found or more than one was found.
     */
    public static function getXSDMF_IDByXDIS_ID($xsdmf_element, $xdis_str)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     * @return  array The XSDMF ID, or false if not found or more than one was found.
     */
    public static function getXSDMF_IDByKeyXDIS_ID($xsdmf_element, $element_value, $xdis_str)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     * @return  array The XSDMF ID, or false if not found or more than one was found.
     */
    public static function getXSDMF_IDByParentKeyXDIS_ID($xsdmf_element, $parent_key, $xdis_str)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     * @return  array The XSDMF ID, or false if not found or more than one was found.
     */
    public static function getXSDMF_IDByKeyXDIS_IDSEL_ID($xsdmf_element, $key_value, $xdis_str, $xsdsel_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();

        if (!is_array($xsdsel_id)) {
            return false;
        }
        $stmt = "SELECT
		                    xsdmf_id
     ...
     * @return  array The XSDMF ID, or false if not found or more than one was found.
     */
    public static function getXSDMF_IDByElementSEL_ID($xsdmf_element, $xsdsel_id, $xdis_str)
    {
        $log = FezLog::get();
        $db = DB_API::get();
    ...
    public static function getOneDetailsBySEL_XSDMF_ID($xsdmf_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
    ...
    public static function getXSDMF_IDByElementSEL_Title($xsdmf_element, $xsdsel_title, $xdis_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
...
//		                    xsdmf_element = ".$db->quote($xsdmf_element)." and xsdmf_xdis_id = ".$xdis_id." and xsdsel_title=" . $db->quote($xsdsel_title);
     ...
     */
    public static function getXSDMF_IDByOriginalXSDMF_ID($original_xsdmf_id, $xdis_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
    ...
    public static function getXSDMF_IDBySekIDXDIS_ID($sek_id, $xdis_str = "", $nocache = false)
    {
        $log = FezLog::get();
        $db = DB_API::get();
    ...
    public static function getDetailsBySekIDXDIS_ID($sek_id, $xdis_str = '')
    {
        $log = FezLog::get();
        $db = DB_API::get();
    ...
    public static function getList($xdis_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
    ...
    private static function getListAll()
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     */
    public static function getDetails($xdis_id, $xml_element)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     */
    public static function getDetailsByXSDMF_ID($xsdmf_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     */
    public static function getXDIS_IDByXSDMF_ID($xsdmf_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     * @return  array $res The xdis_id
     */
    public static function getSmartyVarByXSDMF_ID($xsdmf_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     */
    public static function getDetailsSubelement($xdis_id, $xml_element, $xsdsel_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     */
    public static function getXSD_ID($xdis_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
    ...
    private static function getChildren($xsdmf_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
    ...
    private static function setChild($xsdmf_id, $att_child_xsdmf_id, $att_order)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     *                 or if an array was passed, array(fld_id => array(mfo_id, mfo_value))
     */
    private static function getOptionsValueOnly($fld_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     */
    private static function parseParameters($value)
    {
     ...
     */
    public static function getElementMatchList($xdis_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     * @return  array The list of XSDMF elements
     */
    public static function getElementMatchListDetails($xdis_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     */
    public static function getElementOrphanList($xdis_id, $xsd_array)
    {
        $log = FezLog::get();
        $db = DB_API::get();
    ...
    private static function getSubloopingElementsByXDIS_ID($xdis_id)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     */
    public static function getElementOrphanCount($xdis_id, $xsd_array)
    {
        $log = FezLog::get();
        $db = DB_API::get();
    ...
    public static function exportMatchFields(& $xdis, $xdis_id)
    {
        $list = XSD_HTML_Match::getList($xdis_id);
     ...
     */
    public static function remapImport(& $maps, & $bgp)
    {
        $log = FezLog::get();
        $db = DB_API::get();
...
class XSD_HTML_MatchObject
{
     ...
     */
    public function getXSDMF_IDByParentKeyXDIS_ID($xsdmf_element, $parent_key)
    {
     ...
     */
    public function getXSDMF_IDByXDIS_ID($xsdmf_element, $xsdmf_title = "")
    {
        $log = FezLog::get();
        $db = DB_API::get();
...
//			echo $xsdmf['xsdmf_element'];
     ...
     */
    public function getXSDMFByElement($xsdmf_element, $xdis_ids = null)
    {
        $log = FezLog::get();
        $db = DB_API::get();
     ...
     */
    public function getXSDMF_IDByKeyXDIS_ID($xsdmf_element, $element_value)
    {
        $mc = $this->getMatchCols();
        foreach ($mc as $xsdmf) {
     ...
     * @return  integer The xsdmf_id
     */
    public function getXSDMF_IDBySELXDIS_ID($xsdmf_element, $xsdsel_id)
    {
        $mc = $this->getMatchCols();
        foreach ($mc as $xsdmf) {
    ...
    public function getXSDMF_IDBySEK($sek_id)
    {
     ...
     * @return  array The details
     */
    public function getDetailsByXSDMF_ID($xsdmf_id)
    {
        $mc = $this->getMatchCols();
        foreach ($mc as $xsdmf) {
    ...
    public function getDetailsByElement($xsdmf_element)
    {
        $mc = $this->getMatchCols();
        foreach ($mc as $xsdmf) {
     ...
     */
    public function getXSDMF_ID_ByElementInSubElement($loop_base_element, $loop_name, $element)
    {
    ...
    public function getSELBaseXSDMF_IDByElement($loop_base_element, $xdis_ids = '')
    {
        $log = FezLog::get();
        $db = DB_API::get();
