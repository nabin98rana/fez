 ...
 */
define("APP_SQL_DBHOST", "dbdev.library.uq.edu.au");

/**
 * Database name for the Fez database.
 */
define("APP_SQL_DBNAME", "_fez_siren");

/**
 * Database user.
 */
define("APP_SQL_DBUSER", "fez_siren");

/**
 * Database password.
 */
define("APP_SQL_DBPASS", "Fl4shingr3dd");
 ...
 * this config file.
 */
define("APP_PATH", '/var/www/siren.library.uq.edu.au/public/');
...
include dirname(dirname(__FILE__)) . "/public/init.php";
