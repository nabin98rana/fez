...
br.getPageURI = function(index, reduce, rotate) {
    ...
    var url = bookreaderConfig.host + bookreaderConfig.urlPath + bookreaderConfig.pid + '/' + bookreaderConfig.resource + '/' + bookreaderConfig.resource + '-'+leafStr.replace(re, imgStr) + '.jpg';
    return url;
}
