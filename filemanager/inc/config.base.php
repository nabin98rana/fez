<?php
	...
	define('CONFIG_SYS_DEFAULT_PATH', APP_SAN_IMPORT_DIR); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', APP_SAN_IMPORT_DIR);	//accept relative path only
	define('CONFIG_SYS_FOLDER_SHOWN_ON_TOP', true); //show your folders on the top of list if true or order by name 
	define("CONFIG_SYS_DIR_SESSION_PATH", '../ajaxfilemanager/session/');
