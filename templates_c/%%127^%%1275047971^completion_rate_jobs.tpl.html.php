<?php /* Smarty version 2.6.2, created on 2004-09-14 14:06:48
         compiled from reports/completion_rate_jobs.tpl.html */ ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "header.tpl.html", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<h4>Completion Rate of Jobs for <?php echo $this->_tpl_vars['prj_name']; ?>
 Team</h4>
...
$this->_sections['results_loop']['loop'] = is_array($_loop=$this->_tpl_vars['results'][$this->_tpl_vars['display_num']][0]) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
					<?php if ($this->_tpl_vars['results'][$this->_tpl_vars['display_num']][0][$this->_sections['results_loop']['index']][0] == $this->_tpl_vars['month_list_num'][$this->_sections['month_list_num_loop']['index']]): ?>					
						<?php $this->assign('tempTotal', $this->_tpl_vars['results'][$this->_tpl_vars['display_num']][0][$this->_sections['results_loop']['index']][1]); ?>
					<?php endif; ?>
				<?php endfor; endif; ?>
	        ...
	        <?php endfor; endif; ?>
			<?php $this->assign('tempTotal', '0'); ?>
			<?php $this->assign('tempTotal', $this->_tpl_vars['results'][$this->_tpl_vars['display_num']][1][0][0]); ?>
