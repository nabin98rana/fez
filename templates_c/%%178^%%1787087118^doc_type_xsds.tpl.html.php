<?php /* Smarty version 2.6.2, created on 2005-05-12 11:40:58
         compiled from manage/doc_type_xsds.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'manage/doc_type_xsds.tpl.html', 270, false),)), $this); ?>
...
">
                  <input type="text" name="xsd_title" size="40" class="default" value="<?php echo $this->_tpl_vars['info']['xsd_title']; ?>
">
...
" class="default_white">
                ...
                <td bgcolor="<?php echo $this->_tpl_vars['light_color']; ?>
">
                  <input type="text" name="xsd_version" size="30" class="default" value="<?php echo $this->_tpl_vars['info']['xsd_version']; ?>
">
                </td>
              </tr>
              <tr>
...
" class="default_white" nowrap>
                ...
                <td bgcolor="<?php echo $this->_tpl_vars['light_color']; ?>
">
                  <input type="text" name="xsd_top_element_name" size="30" class="default" value="<?php echo $this->_tpl_vars['info']['xsd_top_element_name']; ?>
">
                </td>
              </tr>
              <tr>
...
" class="default_white" nowrap>
                ...
                <td bgcolor="<?php echo $this->_tpl_vars['light_color']; ?>
">
                  <input type="text" name="xsd_element_prefix" size="30" class="default" value="<?php echo $this->_tpl_vars['info']['xsd_element_prefix']; ?>
">
                </td>
              </tr>
              <tr>
...
" class="default_white" nowrap>
                ...
                <td bgcolor="<?php echo $this->_tpl_vars['light_color']; ?>
">
                  <input type="text" name="xsd_extra_ns_prefixes" size="30" class="default" value="<?php echo $this->_tpl_vars['info']['xsd_extra_ns_prefixes']; ?>
">
                </td>
              </tr>
              <tr>
...
" class="default_white">&nbsp;<b>Version</b>&nbsp;</td>
                      <td width="10%" bgcolor="<?php echo $this->_tpl_vars['cell_color']; ?>
" class="default_white" nowrap>&nbsp;<b>Top Element Name</b>&nbsp;</td>
                      <td width="10%" bgcolor="<?php echo $this->_tpl_vars['cell_color']; ?>
" class="default_white">&nbsp;<b>Element Prefix</b>&nbsp;</td>
                      <td width="10%" bgcolor="<?php echo $this->_tpl_vars['cell_color']; ?>
" class="default_white" nowrap>&nbsp;<b>XSD Source</b>&nbsp;</td>
                      <td width="10%" bgcolor="<?php echo $this->_tpl_vars['cell_color']; ?>
" class="default_white" nowrap>&nbsp;<b>XSD Displays&nbsp;</b></td>
                    </tr>
...
" class="default">
                        &nbsp;<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['xsd_title']; ?>
...
" class="default">
                      ...
                      <td width="15%" bgcolor="<?php echo $this->_tpl_vars['row_color']; ?>
" class="default">
                        &nbsp;<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['xsd_top_element_name']; ?>

                      </td>
                      <td width="15%" bgcolor="<?php echo $this->_tpl_vars['row_color']; ?>
" class="default">
                        &nbsp;<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['xsd_element_prefix']; ?>

                      </td>
                      <td width="15%" bgcolor="<?php echo $this->_tpl_vars['row_color']; ?>
" class="default">
                        &nbsp;<a class="link" href="xsd_source_edit.php?cat=edit&xsd_id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['xsd_id']; ?>
" title="edit this XSDs source XML">Edit</a>
                      </td>
                      <td width="15%" bgcolor="<?php echo $this->_tpl_vars['row_color']; ?>
" class="default">
                        &nbsp;<a class="link" href="xsd_displays.php?xsd_id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['xsd_id']; ?>
" title="edit this XSDs Displays">Edit</a>
                      </td>
                    </tr>
                    <?php endfor; else: ?>
                    <tr>
