<?php /* Smarty version 2.6.2, created on 2005-03-16 12:38:58
         compiled from manage/xsd_displays.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'manage/xsd_displays.tpl.html', 236, false),)), $this); ?>
...
" class="default_white">
                ...
                <td bgcolor="<?php echo $this->_tpl_vars['light_color']; ?>
">
                  <input type="text" name="xdis_version" size="30" class="default" value="<?php echo $this->_tpl_vars['info']['fld_version']; ?>
">
                </td>
              </tr>
              <tr>
...
" align="center">
                        <input type="checkbox" name="items[]" value="<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['xdis_id']; ?>
" <?php if ($this->_sections['i']['total'] == 0): ?>disabled<?php endif; ?>>
                      </td>
                      <td width="50%" bgcolor="<?php echo $this->_tpl_vars['row_color']; ?>
" class="default">
                        &nbsp;<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['xdis_title']; ?>

                      </td>
                      <td width="15%" bgcolor="<?php echo $this->_tpl_vars['row_color']; ?>
" class="default">
                        &nbsp;<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['xdis_version']; ?>

                      </td>
                      <td width="15%" bgcolor="<?php echo $this->_tpl_vars['row_color']; ?>
" class="default">
                        &nbsp;<a class="link" href="xsd_tree_match.php?&xdis_id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['xdis_id']; ?>
