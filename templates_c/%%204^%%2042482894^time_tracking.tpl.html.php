<?php /* Smarty version 2.6.2, created on 2004-06-25 09:32:23
         compiled from manage/time_tracking.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'manage/time_tracking.tpl.html', 109, false),)), $this); ?>
            ...
            <table bgcolor="#FFFFFF" width="100%" cellspacing="1" cellpadding="2" border="0">
              ...
              function validateForm(f)
              {
                  if (isWhitespace(f.title.value)) {
                      alert(\'Please enter the title of this time tracking category\');
                      selectField(f, \'title\');
                      return false;
                  }
                  return true;
              ...
              <form name="time_tracking_form" onSubmit="javascript:return validateForm(this);" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>
">
...
">
              ...
              <tr>
                <td colspan="2" class="default">
                  <b>Manage Time Tracking Categories</b>
                </td>
              </tr>
...
" align="center" class="error">
                  <?php if ($_POST['cat'] == 'new'): ?>
                    ...
                    <?php elseif ($this->_tpl_vars['result'] == -2): ?>
                      Please enter the title for this new time tracking category.
                    <?php elseif ($this->_tpl_vars['result'] == 1): ?>
                      Thank you, the time tracking category was added successfully.
                    <?php endif; ?>
                  <?php elseif ($_POST['cat'] == 'update'): ?>
                    <?php if ($this->_tpl_vars['result'] == -1): ?>
                      An error occurred while trying to update the time tracking category information.
                    <?php elseif ($this->_tpl_vars['result'] == -2): ?>
                      Please enter the title for this time tracking category.
                    <?php elseif ($this->_tpl_vars['result'] == 1): ?>
                      Thank you, the time tracking category was updated successfully.
                    <?php endif; ?>
                  <?php endif; ?>
                </td>
              </tr>
...
">
                  <input type="text" name="title" size="40" class="default" value="<?php echo $this->_tpl_vars['info']['ttc_title']; ?>
">
                ...
                <td colspan="2">
                  ...
                  function checkDelete(f)
                  {
                      if (!hasOneChecked(f, \'items[]\')) {
                          alert(\'Please select at least one of the time tracking categories.\');
                          return false;
                      }
...
"><input type="checkbox" name="items[]" value="<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['ttc_id']; ?>
"></td>
                      <td width="100%" bgcolor="<?php echo $this->_tpl_vars['row_color']; ?>
" class="default">
                        &nbsp;<a class="link" href="<?php echo $_SERVER['PHP_SELF']; ?>
?cat=edit&id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['ttc_id']; ?>
" title="update this entry"><?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['ttc_title']; ?>
</a>
                      </td>
                    </tr>
                    <?php endfor; else: ?>
