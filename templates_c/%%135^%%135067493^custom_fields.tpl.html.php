<?php /* Smarty version 2.6.2, created on 2004-07-02 10:54:23
         compiled from manage/custom_fields.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'manage/custom_fields.tpl.html', 201, false),array('function', 'cycle', 'manage/custom_fields.tpl.html', 321, false),)), $this); ?>
...
">
                  <span class="default">
                  <input type="checkbox" name="report_form" value="1" <?php if ($this->_tpl_vars['info']['fld_report_form'] == 1): ?>checked<?php endif; ?>> <a id="link" class="link" href="javascript:void(null);" onClick="javascript:toggleCheckbox('custom_field_form', 'report_form', 0);checkRequiredFields();">Report Form</a><br />
                  ...
                  <input type="checkbox" name="anon_form" value="1" <?php if ($this->_tpl_vars['info']['fld_anonymous_form'] == 1): ?>checked<?php endif; ?>> <a id="link" class="link" href="javascript:void(null);" onClick="javascript:toggleCheckbox('custom_field_form', 'anon_form', 0);checkRequiredFields();">Anonymous Form</a><br />
...
" class="default_white">&nbsp;<b>Assigned Teams</b></td>
...
" class="default">
                        <nobr>&nbsp;<?php if ($this->_tpl_vars['list'][$this->_sections['i']['index']]['fld_type'] == 'combo'): ?>Combo Box<?php elseif ($this->_tpl_vars['list'][$this->_sections['i']['index']]['fld_type'] == 'multiple'): ?>Multiple Combo Box<?php elseif ($this->_tpl_vars['list'][$this->_sections['i']['index']]['fld_type'] == 'textarea'): ?>Textarea<?php else: ?>Text Input<?php endif; ?></nobr>
                      </td>
