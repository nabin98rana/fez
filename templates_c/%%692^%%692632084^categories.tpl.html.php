<?php /* Smarty version 2.6.2, created on 2004-07-07 16:28:24
         compiled from manage/categories.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'manage/categories.tpl.html', 114, false),)), $this); ?>
            ...
            <table bgcolor="#FFFFFF" width="100%" cellspacing="1" cellpadding="2" border="0">
              ...
              function validateForm(f)
              {
                  if (isWhitespace(f.title.value)) {
                      alert(\'Please enter the title of this category\');
                      selectField(f, \'title\');
                      return false;
                  }
                  return true;
              ...
              <form name="category_form" onSubmit="javascript:return validateForm(this);" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>
">
...
">
                  <input type="text" name="title" size="40" class="default" value="<?php echo $this->_tpl_vars['info']['prc_title']; ?>
">
...
"><input type="checkbox" name="items[]" value="<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['prc_id']; ?>
"></td>
                      <td width="100%" bgcolor="<?php echo $this->_tpl_vars['row_color']; ?>
" class="default">
                        &nbsp;<a class="link" href="<?php echo $_SERVER['PHP_SELF']; ?>
?cat=edit&id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['prc_id']; ?>
&prj_id=<?php echo $this->_tpl_vars['project']['prj_id']; ?>
" title="update this entry"><?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['prc_title']; ?>
</a>
                        &nbsp;<a class="link" href="<?php echo $_SERVER['subcategories']; ?>
subcategories.php?id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['prc_id']; ?>
&prj_id=<?php echo $this->_tpl_vars['project']['prj_id']; ?>
" title="Manage Subcategories">(Manage Subcategories)</a>
                      </td>
                    </tr>
                    <?php endfor; else: ?>
                    <tr>
