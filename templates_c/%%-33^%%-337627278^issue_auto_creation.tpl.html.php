<?php /* Smarty version 2.6.2, created on 2004-06-25 11:23:55
         compiled from manage/issue_auto_creation.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'manage/issue_auto_creation.tpl.html', 93, false),)), $this); ?>
          ...
          <td>
            <table bgcolor="#FFFFFF" width="100%" cellspacing="1" cellpadding="2" border="0">
              ...
              function validateForm(f)
              {
                  ...
                  if (field1.checked) {
                      var field = getFormElement(f, \'options[reporter]\');
                      if (field.selectedIndex == 0) {
                          selectField(f, \'options[reporter]\');
                          alert(\'Please choose the reporter.\');
                          return false;
                      }
