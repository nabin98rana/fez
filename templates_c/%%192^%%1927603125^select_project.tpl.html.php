<?php /* Smarty version 2.6.2, created on 2004-06-25 14:08:32
         compiled from select_project.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'select_project.tpl.html', 47, false),)), $this); ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "header.tpl.html", 'smarty_include_vars' => array('extra_title' => 'Select Project')));
  ...
  <tr>
    <td>
      <table bgcolor="#006486" width="100%" border="0" cellspacing="0" cellpadding="4">
        ...
        <tr>
          <td colspan="2" align="center" class="error">
            ...
            <?php if ($this->_tpl_vars['err'] == 1 || $_GET['err'] == 1): ?>
              You are not allowed to use the selected project.
            <?php endif; ?>
            </b>
          </td>
        </tr>
        <?php endif; ?>
        <tr>
          <td align="right" width="40%" class="default_white"><b><u>P</u>roject:</b></td>
          <td width="60%">
            <select accessKey="p" name="project" class="default" tabindex="0">
